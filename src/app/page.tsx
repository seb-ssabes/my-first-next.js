...
export default function Home() {
  return (
    <main>
      <section className="flex flex-col-reverse items-center justify-between gap-8 px-6 py-12
      mx-auto md:flex-row max-w-7xl">
        <div className="flex-1 space-y-6">
          ...
          <div className="flex gap-4">
            <button className="px-6 py-3 text-black transition duration-100 bg-white border-2
